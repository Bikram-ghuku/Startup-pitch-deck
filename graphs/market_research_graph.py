...
async def market_research_graph(
    ...
    def should_continue_iteration(state: Dict) -> str:
    ...
    # Conditional branching based on check_iteration result
    workflow.add_conditional_edges(
        "check_iteration",
        lambda x: x,  # Use the output directly
        {
            "continue_iteration": "innovation",
            "finalize": "create_pitch_deck"
        }
    )
